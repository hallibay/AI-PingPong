...
async function init(){
    ...
    model =  await tf.loadModel('https://cors-anywhere.herokuapp.com/http://kehindeogundeyi.com/js/tfjs/model.json');
    //model =  await tf.loadLayersModel('https://cors-anywhere.herokuapp.com/http://kehindeogundeyi.com/js/model.json', {mode: 'no-cors'});
    //model =  await tf.loadModel('https://localhost:44377/assets/js/model.json', {mode: 'no-cors'});
    //const tf = require("@tensorflow/tfjs");
//const tfn = require("@tensorflow/tfjs-node");
//const handler = tfn.io.fileSystem("./tfjs/tfjsmodel/model.json");
//const model = await tf.loadModel(handler);
    //model =  await tf.loadModel('localstorage://model.json');
